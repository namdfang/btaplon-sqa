    ...
    <body>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <h3 style="margin: 20px; text-align: center;">THÊM MỚI KHOẢN GIẢM TRỪ</h3>
                    <form action="addReduce" method="post">    
                        ...
                        <div class="form-group row" style="margin:10px 100px">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="measure" value="${measure}" class="form-control">
                            </div>
                        </div>
