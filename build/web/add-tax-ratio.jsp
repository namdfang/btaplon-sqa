    ...
    <body>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <h3 style="margin: 20px; text-align: center;">THÊM MỚI BẬC THUẾ SUẤT</h3>
                    <form action="addTaxRatio" method="post"> 
                        ...
                        <div class="form-group row" style="margin:50px 100px 10px 100px">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="level" value="${level}" placeholder="Bậc" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row" style="margin:50px 100px 10px 100px">
                            <label class="col-sm-3 col-form-label">Từ (tr.Đ)</label>
                            <div class="col-sm-9">
                                <input type="number" name="minIncome" value="${minIncome}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row" style="margin:50px 100px 10px 100px">
                            <label class="col-sm-3 col-form-label">Đến (tr.Đ)</label>
                            <div class="col-sm-9">
                                <input type="number" name="maxIncome" value="${maxIncome}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row" style="margin:10px 100px">
                            <label class="col-sm-3 col-form-label">Thu nhập tính thuế (TNTT):</label>
                            <div class="col-sm-9">
                            <input type="text" name="description" value="${description}" placeholder="Trên...tr đến...tr" class="form-control">
                            </div>
                        </div>
                            <div class="form-group row" style="margin:10px 100px">
                            <label class="col-sm-3 col-form-label">Thuế suất (%)</label>
                            <div class="col-sm-9">
                                <input type="number" name="ratio" value="${ratio}" class="form-control">
                            </div>
                        </div>
